/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 7c79653ed292a4cc8bb9173b1c468ce4)
// Runtime types generated with workerd@1.20251217.0 2025-12-23 nodejs_als
declare namespace Cloudflare {
	interface Env {
		CLOUDFLARE_D1_TOKEN: string;
		CLOUDFLARE_ACCOUNT_ID: string;
		CLOUDFLARE_PROD_D1_ID: string;
		CLOUDFLARE_STG_D1_ID: string;
		DB: D1Database;
	}
}
